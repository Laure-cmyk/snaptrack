...
// Check if a top3 user should be highlighted
...
<template>
    <v-card rounded="lg" elevation="0" style="background-color: white;">
        <v-card-text class="pa-0">
            ...
            <!-- Additional users sorted by rank -->
