...
const courses = computed(() => {
  ...
  return journeysData.value.journeys.map(journey => ({
    ...
    image:
      journey.image || 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80',
    city: journey.town || ''
  }));
});
...
<template>
  ...
  <v-main class="bg-grey-lighten-4 main-content">
    ...
    <div
      ...
      style="position: sticky; top: -120px; z-index: 10; transition: all 0.3s ease"
    >
      <!-- Header Section -->
